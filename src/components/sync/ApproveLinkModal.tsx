            ...
            <>
              ...
              <footer className="flex justify-end gap-2 border-t border-divider px-5 py-4">
                <button type="button" onClick={ablehnen} disabled={laeuft}
                  className="flex h-10 items-center gap-2 rounded-md px-4 text-xs font-bold uppercase tracking-widest text-muted transition-colors hover:text-danger disabled:opacity-40">
                  <X size={13} /> Ablehnen
                </button>
