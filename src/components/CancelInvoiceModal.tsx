        ...
        >
          ...
          >
            <div className="p-6">
              ...
              <label className="mt-4 mb-2 block text-[10px] font-bold uppercase tracking-[0.2em] text-muted">Stornogrund (optional)</label>
              <textarea
                value={reason}
            ...
            <div className="flex justify-end gap-2 border-t border-divider px-6 py-4">
              ...
              <button
                ...
                className="cursor-pointer rounded-md bg-amber-500/15 px-4 py-2 text-xs font-bold uppercase tracking-widest text-amber-400 transition-all hover:bg-amber-500 hover:text-white active:scale-95"
              >
                Stornieren
              </button>
            </div>
